...
class JSONLLogger:
    ...
    def log_session_start(self, session_id: str, metadata: Optional[Dict] = None) -> None:
    ...
    def log_tool_start(self, tool_name: str, call_id: str, args: Optional[Dict] = None) -> None:
        """Log tool call start."""
        self.log("tool_start", {
            "tool": tool_name,
            "call_id": call_id,
    ...
    def log_tool_end(self, tool_name: str, call_id: str, 
