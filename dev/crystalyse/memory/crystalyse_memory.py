...
class CrystaLyseMemory:
    ...
    def __init__(self, user_id: str = "default", memory_dir: Path | None = None):
        """
    ...
    def get_cached_discovery(self, formula: str) -> dict[str, Any] | None:
        """
    ...
    def auto_generate_insights(self) -> str | None:
        """
    ...
    def export_memory(self, export_dir: Path) -> None:
        ...
        try:
            ...
            if self.cross_session_context.insights_file.exists():
                shutil.copy2(
                    self.cross_session_context.insights_file,
                    export_dir / f"insights_{self.user_id}.md",
                )
            ...
            try:
                ...
                if not merge:
                    ...
                    self.user_memory.add_fact(
                        f"Imported memory content: {imported_content[:100]}..."
                    )
