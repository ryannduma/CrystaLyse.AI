...
try:
    ...
    crystalyse_parent = os.path.dirname(
...
class MCPConnectionPool:
    ...
    async def get_connection(self, server_name: str) -> MCPServerStdio | None:
    ...
    async def _establish_connection(self, server_name: str) -> MCPServerStdio | None:
        ...
        for attempt in range(self.max_reconnect_attempts):
            try:
                ...
                if attempt < self.max_reconnect_attempts - 1:
                    ...
                    logger.error(
                        f"❌ Failed to establish connection to {server_name} after {self.max_reconnect_attempts} attempts"
                    )
