...
class UserPreferenceMemory:
        ...
        try:
            ...
            if profiles_file.exists():
                ...
                for user_id, profile_data in data.items():
                    ...
                    profile_data["creation_date"] = datetime.fromisoformat(
    ...
    def get_or_create_profile(self, user_id: str) -> UserProfile:
        ...
        if user_id not in self.profiles:
            self.profiles[user_id] = UserProfile(
                user_id=user_id, creation_date=datetime.now(), last_updated=datetime.now()
            )
    ...
    def learn_from_interaction(self, user_id: str, interaction: UserInteractionRecord):
        ...
        if profile.interaction_count == 1:
            ...
            profile.average_expertise_level = (
                1 - weight
            ) * profile.average_expertise_level + weight * expertise_numeric
        ...
        logger.debug(
            f"Updated profile for {user_id}: expertise={profile.average_expertise_level:.2f}, speed_pref={profile.speed_preference:.2f}"
        )
    ...
    def get_personalized_strategy(self, user_id: str, analysis) -> dict[str, Any]:
        ...
        if (
            ...
            and profile.average_expertise_level > 0.8
            and profile.skip_clarification_rate < 0.2
        ):  # Low frustration with skipping
            # More aggressive skipping for learned experts
            if (
                analysis
                and analysis.expertise_level == "expert"
                and analysis.specificity_score > 0.7
    ...
    def _expertise_to_numeric(self, expertise_level: str) -> float:
        ...
        mapping = {"novice": 0.2, "intermediate": 0.6, "expert": 0.9}
    ...
    def get_user_statistics(self, user_id: str) -> dict[str, Any]:
        ...
        stats = {
            ...
            "successful_modes": {
                mode: sum(scores) / len(scores) for mode, scores in profile.successful_modes.items()
            },
