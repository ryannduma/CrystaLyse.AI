...
class CreativeFormatter:
    ...
    def extract_cif_files_creative(
        ...
        for i, item in enumerate(new_items):
            ...
            logger.info(
                f"Item {i}: ToolCallOutputItem={has_tool_output}, creative_pipeline={has_creative}, most_stable_cifs={has_cifs}"
            )
                        ...
                        if cif_data:
                            ...
                            for comp, cif_content in cif_data.items():
                                ...
                                try:
                                    ...
                                    logger.info(
                                        f"Extracted CIF for {comp} from creative mode output"
                                    )
