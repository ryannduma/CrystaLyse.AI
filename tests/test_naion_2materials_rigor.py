#!/usr/bin/env python3
"""
Na-ion battery cathode discovery: 2 materials with full rigor mode.
...
async def test_naion_2materials_rigor():
    """Test complete rigor mode workflow for 2 Na-ion battery cathodes."""
    print("🔋 Na-ion Battery Cathode Discovery - 2 Materials Full Rigor Mode")
    print("=" * 70)
...
Focus on exactly 2 well-known, promising cathode materials to ensure thorough analysis within computational limits."""
    
    print(f"🚀 Starting 2-material Na-ion cathode analysis...")
    ...
    try:
        ...
        print()
        print("📋 2-MATERIAL NA-ION CATHODE ANALYSIS:")
        print("=" * 80)
        print(result)
        print("=" * 80)
        ...
        filename = f"naion_2materials_rigor_{timestamp}.txt"
        with open(filename, "w") as f:
            f.write("Na-ion Battery Cathode Discovery - 2 Materials Full Rigor Mode\n")
            f.write("=" * 70 + "\n\n")
...
async def main():
    """Run the 2-material Na-ion cathode test."""
    print("🧪 CrystaLyse.AI Full Integration Test")
    print("🔬 Testing complete computational workflow\n")
    
    success = await test_naion_2materials_rigor()
