...
from crystalyse.ui.user_preference_memory import (
    UserInteractionRecord,
    UserPreferenceMemory,
)
from crystalyse.workspace.workspace_tools import ClarificationRequest, QueryAnalysis, Question
...
class TestIntegratedClarificationSystem:
    ...
    def setup_method(self):
        ...
        self.system = IntegratedClarificationSystem(console=self.console, user_id="test_user")
    ...
    def test_query_analysis_expert(self):
        ...
        expert_query = (
            "Calculate the formation energy of LiCoO2 using DFT and compare phonon dispersions"
        )
    ...
    def test_query_analysis_urgency_detection(self):
        ...
        assert any(
            "fast" in indicator or "urgent" in indicator
    ...
    def test_expertise_detection_patterns(self):
        ...
        assert (
            self.system._detect_expertise_level("crystal structure properties synthesis")
            == "intermediate"
        )
...
class TestDynamicModeAdapter:
    ...
    async def test_safety_critical_adaptation(self):
        ...
        current_mode = "creative"
        context = {"safety_critical_detected": True}
...
class TestEducationalFeatures:
    ...
    def test_input_guidance_generation(self):
        ...
        question = Question(
            id="elements_to_include", text="Which elements to include?", options=None
        )
...
class TestFullWorkflow:
    ...
    async def test_novice_guided_discovery(self):
        ...
        questions = [
            Question(
                id="application", text="Application?", options=["Electronics", "Automotive", "Grid"]
            ),
